...
myTotemRPOrganization :: ~myTotemRPOrganization()
{
}


uint32_t myTotemRPOrganization::GetUnitID(const G4Step* aStep) const
{
  return const_cast<myTotemRPOrganization *>(this)->GetUnitID(aStep);
}


uint32_t myTotemRPOrganization::GetUnitID(const G4Step* aStep)
{
