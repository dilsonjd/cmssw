...
run3_RPC.toModify( rawDataCollector.RawCollectionList, func = lambda list: list.append(cms.InputTag("RPCTwinMuxDigiToRaw")) )
run3_RPC.toModify( rawDataCollector.RawCollectionList, func = lambda list: list.append(cms.InputTag("rpcCPPFDigiToRaw")) )
