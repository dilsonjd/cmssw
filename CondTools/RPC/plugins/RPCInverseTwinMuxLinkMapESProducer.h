...
//  edm::ESGetToken<RPCInverseAMCLinkMap, RPCTwinMuxLinkMapRcd> es_rpc_tm_l_map_token_;	//const es_rpc_tm_l_map_token_;
  edm::ESGetToken<RPCAMCLinkMap, RPCTwinMuxLinkMapRcd> es_rpc_tm_l_map_token_;	//const es_rpc_tm_l_map_token_;
};
